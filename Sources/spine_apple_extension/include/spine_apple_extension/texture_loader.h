...
SPINE_C_API spine_atlas _Nonnull spine_atlas_load_with_loader(const char *__null_terminated _Nonnull path,
															  spine_texture_loader _Nonnull textureLoader, bool createTexture);
SPINE_C_API spine_atlas _Nonnull spine_atlas_create_with_loader(const char *__counted_by(length) _Nonnull data, int length,
																const char *__null_terminated _Nullable dir,
																spine_texture_loader _Nonnull textureLoader, bool createTexture);
