...
// spine_skeleton_binary spine_skeleton_binary_create2(spine_attachment_loader
// attachmentLoader, bool ownsLoader) {
//     return (spine_skeleton_binary) new (__FILE__, __LINE__)
//     SkeletonBinary((AttachmentLoader *)attachmentLoader, ownsLoader);
// }
