...
spine_atlas2 spine_atlas2_create(const char *_Nonnull path, spine_texture_loader textureLoader, bool createTexture) {
...
spine_atlas2 spine_atlas2_create_from_data(const char *data, int length, const char *dir, spine_texture_loader textureLoader, bool createTexture) {
